...
class AddForm extends React.Component {
  ...
  getValidateStatus(field) {
    const { isFieldValidating, getFieldError, getFieldValue} = this.props;
  ...
  render() {
    ...
    return (
      <Modal visible={(this.props.name)?this.state.visible:!this.state.visible}
             onOk={this.handleOk}
